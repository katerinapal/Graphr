document.getElementById('element15').onclick = function() {
	jsgui.hideSidebar();
}

document.getElementById('element17').onclick = function() {
	jsgui.showSidebar();
}
...
document.getElementById('element91').onclick = function() {
	jsgui.evaluate();
}

document.getElementById('element92').onclick = function() {
	jsgui.addInput();
}
...
document.getElementById('element113').onclick = function() {
	about();
}
